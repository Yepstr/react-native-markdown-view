...
const renderFactory = ({
  ...
  const renderImage = (node: ImageNode, output: OutputFunction, state: RenderState, styles: RenderStyles) => {
  ...
  const renderTableCell = (cell, row, column, rowCount, columnCount, output, state, styles) => {
